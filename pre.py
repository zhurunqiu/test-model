...
if st.button("Predict"):
    ...
    if predicted_class == 1:
        advice = (
            f"Dear Doctor/Patient, according to our model, you have a high risk of occult lymph node metastasis. "
        ...
        advice = (
            f"Dear Doctor/Patient, according to our model, you have a low risk of occult lymph node metastasis. "
